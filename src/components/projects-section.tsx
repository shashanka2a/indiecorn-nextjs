...
const projects = [
  ...
  },
  {
    ...
    icon: "📸",
    description: "Capture life's best moments. Find the perfect photographer for your special moments. Browse portfolios and book with confidence.",
  ...
  },
  {
    ...
    icon: "🤖",
    description: "Agentic intelligence for markets that never sleep. The living co-pilot for traders with AI-powered market analysis and risk management.",
